...
var Api = function(options){
  ...
  // set up endpoints
  this.endpoints = {};
  var apidir = (options && options.apidir) ? apidir : process.cwd() + '/lib/api';
  walk(apidir,function(file,folder){
    this.endpoints[file.replace(/\.js$/,'')] = require(folder + '/' + file);
  }.bind(this),function(){
    this.providers = new Providers(function(){
      this.ready = true;
...
// Export as a singleton (sort of)
module.exports = new Api();

// Export the uninstantiated class for use in tests.
