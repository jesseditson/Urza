...
var MongoDB = module.exports = function(options){
  ...
  this.models = {};
  this.collections = {};
  walk("./lib/providers/schemas",function(file,folder){
    if(file.match(/\.js$/)){
      // grab the filename, uppercase it.
      var modelName = file.replace(/\.js$/,''),
          modelName = modelName.charAt(0).toUpperCase() + modelName.slice(1),
          // load in the model.
          module = require(process.cwd() + '/' + folder + '/' + file);
      // store as model.
...
MongoDB.prototype.findOperation = function(operation,collection,find,fields,options,callback){
 if(!callback && !options && !fields){
  ...
  getModel(collection)[operation](find,fields,options,function(e,r){
...
MongoDB.prototype.all = function(collection,callback){
